...
def find_latest_checkpoint(checkpoint_dir):
    files = [f for f in os.listdir(checkpoint_dir) if f.endswith("88_final.pt")]
    if not files:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="./output/prebuilt_diffusion", help="Output base folder")
